...
const HIGH_ANTICIPATED_GAMES: UpcomingGame[] = [
  {
    appId: 1030300,
    name: 'Hollow Knight: Silksong',
    headerImage: 'https://cdn.cloudflare.steamstatic.com/steam/apps/1030300/header.jpg',
  ...
  },
  {
    ...
    headerImage: 'https://cdn.cloudflare.steamstatic.com/steam/apps/2767030/header.jpg',
    releaseDate: '2025',
    comingSoon: true,
    price: null,
    discountPercent: 0,
  ...
  },
  {
    ...
    headerImage: 'https://cdn.cloudflare.steamstatic.com/steam/apps/2622590/header.jpg',
    releaseDate: '2025',
    comingSoon: true,
    price: 6999,
    discountPercent: 0,
  ...
  },
  {
    appId: 2378810,
    name: 'GTA 6',
    headerImage: 'https://cdn.cloudflare.steamstatic.com/steam/apps/271590/header.jpg', // placeholder
    releaseDate: 'TBA',
    comingSoon: true,
    price: null,
    discountPercent: 0,
  ...
  },
  {
    appId: 2054970,
    name: 'Judas',
    headerImage: 'https://cdn.cloudflare.steamstatic.com/steam/apps/2054970/header.jpg',
    releaseDate: '2025',
    comingSoon: true,
    price: 5999,
    discountPercent: 0,
  ...
  },
  {
    ...
    headerImage: 'https://cdn.cloudflare.steamstatic.com/steam/apps/2677660/header.jpg',
  ...
  },
  {
    ...
    headerImage: 'https://cdn.cloudflare.steamstatic.com/steam/apps/1716740/header.jpg',
    releaseDate: '2025',
    comingSoon: true,
    price: 5999,
    discountPercent: 0,
  ...
  },
  {
    ...
    headerImage: 'https://cdn.cloudflare.steamstatic.com/steam/apps/2138330/header.jpg',
    releaseDate: '2025',
    comingSoon: true,
    price: 3999,
    discountPercent: 0,
  ...
  },
  {
    ...
    headerImage: 'https://cdn.cloudflare.steamstatic.com/steam/apps/2669320/header.jpg',
    releaseDate: 'Feb 2025',
    comingSoon: true,
    price: 5999,
    discountPercent: 0,
  ...
  },
  {
    appId: 2358720,
    name: 'Hades II',
    headerImage: 'https://cdn.cloudflare.steamstatic.com/steam/apps/1145350/header.jpg',
  ...
  },
  {
    appId: 2656280,
    name: 'Subnautica 2',
    headerImage: 'https://cdn.cloudflare.steamstatic.com/steam/apps/2656280/header.jpg',
    releaseDate: '2025 (Early Access)',
    comingSoon: true,
    price: 2999,
    discountPercent: 0,
      ...
      try {
        ...
        if (apiData.games) {
          for (const game of apiData.games) {
            if (!allGames.find(g => g.appId === game.appId) && game.followers > 0) {
              allGames.push({
                ...game,
          ...
          return (
            <Card key={game.appId} className="overflow-hidden">
              ...
              <CardContent className="pt-4">
                <Link href={`/game/${game.appId}`} className="hover:underline">
